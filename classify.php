<?php
    ...
    $sql_cmd = "SELECT 
        ...
        OFFSET ?";
    $stmt = $conn->prepare($sql_cmd);
    $stmt->bind_param('iii', $classify_id, $per_page, $offset);
    $stmt->execute();
...
<html lang="en">
  ...
  <nav>
    ...
    <section>
      <div class="container">
        <div class="row">
          <div class="article_list col-md-8" id="article_list">
            ...
            <div class="article_item container">
                ...
                <span class="classify"><?php echo $row['classify_name'] ?></span><br/>
